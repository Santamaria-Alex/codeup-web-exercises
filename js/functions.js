...
//    return bill * tip
//}
//var bill = prompt("What was the bill?");
...
var tipPerc = parseFloat(prompt("What percent what you like to tip?"));

var tipAmount = calculateTip(tipPerc, bill);
var total = bill + tipAmount;

alert("Your bill came out to $" + total.toFixed(2));
...
function applyDiscount(origPrice, markDownPerc) {
    var priceAfterDiscount = (origPrice - (origPrice * markDownPerc));
